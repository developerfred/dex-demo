...
func NewMsgPost(owner sdk.AccAddress, marketID storeutils.EntityID, direction matcheng.Direction, price sdk.Uint, quantity sdk.Uint, tif uint16) MsgPost {
	return MsgPost{
		Owner:       owner,
		MarketID:    marketID,
		Direction:   direction,
...
func NewMsgCancel(owner sdk.AccAddress, orderID storeutils.EntityID) MsgCancel {
	return MsgCancel{
		Owner:   owner,
		OrderID: orderID,
	}
