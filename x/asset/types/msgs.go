...
func NewMsgMint(id storeutils.EntityID, minter sdk.AccAddress, amount sdk.Uint) MsgMint {
	return MsgMint{
		ID:     id,
		Minter: minter,
		Amount: amount,
...
func NewMsgBurn(id storeutils.EntityID, burner sdk.AccAddress, amount sdk.Uint) MsgBurn {
	return MsgBurn{
		ID:     id,
		Burner: burner,
		Amount: amount,
...
func NewMsgTransfer(id storeutils.EntityID, from sdk.AccAddress, to sdk.AccAddress, amount sdk.Uint) MsgTransfer {
	return MsgTransfer{
		ID:     id,
		From:   from,
		To:     to,
